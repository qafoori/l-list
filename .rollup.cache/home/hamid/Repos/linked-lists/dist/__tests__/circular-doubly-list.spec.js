import { CircularDoublyLinkedList } from '../modules';
describe('TEST CIRCULAR-DOUBLY-LINKED-LIST', () => {
    it('should convert linked list to array', () => {
        const lList = new CircularDoublyLinkedList();
    ...
    it('should check if linked list is empty', () => {
        ...
        const filledList = new CircularDoublyLinkedList();
...
//# sourceMappingURL=circular-doubly-list.spec.js.map